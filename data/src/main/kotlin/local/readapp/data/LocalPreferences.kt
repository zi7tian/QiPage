...
class LocalPreferences(context:Context):PreferencesRepository {
    ...
    override suspend fun update(preferences:ReaderPreferences) { store.edit {
        ...
        it[line]=preferences.lineSpacing.coerceIn(1.2f,2.4f);it[paragraph]=preferences.paragraphSpacing.coerceIn(0,24);it[margin]=preferences.pageMargin.coerceIn(8,40);it[rule]=preferences.chapterRule
    } }
}
